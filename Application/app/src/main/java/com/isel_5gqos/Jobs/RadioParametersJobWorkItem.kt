...
import com.isel_5gqos.utils.MobileUtils.LocationUtils
import com.isel_5gqos.utils.MobileUtils.MobileInfoUtils
import com.isel_5gqos.utils.MobileUtils.RadioParametersUtils
import java.util.*
...
class RadioParametersJobWorkItem : JobService() {
    ...
    private fun insertInfoInDb(sessionId: String, wrapperDto: WrapperDto) {
        ...
        asyncTask({ QosApp.db.radioParametersDao().invalidateRadioParameters(sessionId) }) {
