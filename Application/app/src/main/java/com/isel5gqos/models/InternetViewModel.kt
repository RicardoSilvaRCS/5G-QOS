...
class InternetViewModel : ViewModel() {
    ...
    val liveData: MutableLiveData<com.isel5gqos.models.Ping> by lazy {
        MutableLiveData<com.isel5gqos.models.Ping>()
    }

    val pingResult: com.isel5gqos.models.Ping get() = liveData.value ?: Ping(0, "")

    fun observe(owner: LifecycleOwner, observer: (com.isel5gqos.models.Ping) -> Unit) {
